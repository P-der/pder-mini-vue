...
function provide(key, value) {
    ...
    if (currentInstance) {
        var parent_1 = currentInstance.parent, provides = currentInstance.provides;
        if (parent_1.provides === provides) {
            provides = currentInstance.provides = Object.create(parent_1.provides);
        }
        provides[key] = value;
    }
}
function inject(key, defaultValue) {
    ...
    if (currentInstance) {
        ...
        if (key in parent_2.provides) {
            return parent_2.provides[key];
        }
        if (defaultValue) {
...
export { Fragment, Text, createApp, createComponentInstance, createTextVnode, createVnode, getCurrentInstance, h, inject, provide, renderSlot, setupComponent };
